...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitudeTxtView = findViewById(R.id.latitudeTextView);
        longitudeTxtView = findViewById(R.id.longitudeTextView);
        sourceTxtView = findViewById(R.id.sourceTextView);
       ...
       /* if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            CellLocation locationManager;
            locationManager.requestLocationUpdate(LocationManager.GPS_PROVIDER, locationListener);
        } else {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        ObjectAnimator rotationAnimation = ObjectAnimator.ofFloat(compassImageView, "rotation", -oldAzimuth, -azimuth);
